        ...
        <section className="py-24 px-4">
          <div className="container mx-auto max-w-4xl">
            <motion.div
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-primary/90 to-primary/70 rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/80 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
                  Присоединяйтесь к 300+ фрилансерам и заказчикам, которые уже строят будущее децентрализованной работы.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  {!user ? (
                    <Link
                      to="/login"
                      className="inline-flex items-center justify-center px-6 py-3 bg-white text-primary rounded-xl font-semibold hover:bg-white/90 transition-colors">
                      Войти / Регистрация
                    </Link>
                  ) : (
                    <Link
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 bg-transparent border border-white/30 rounded-xl font-semibold hover:bg-white/10 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-muted-foreground max-w-sm">
                Децентрализованная платформа для фрилансеров и заказчиков, построенная на открытом коде.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-foreground">Платформа</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link to="/tasks" className="hover:text-primary transition-colors">Проекты</Link></li>
                <li><Link to="/roadmap" className="hover:text-primary transition-colors">Дорожная карта</Link></li>
                <li><Link to="/login" className="hover:text-primary transition-colors">Регистрация</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-foreground">Правовая информация</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="#" className="hover:text-primary transition-colors">Условия использования</a></li>
                <li><a href="#" className="hover:text-primary transition-colors">Политика конфиденциальности</a></li>
                <li><a href="#" className="hover:text-primary transition-colors">Правила платформы</a></li>
              </ul>
            </div>
          </div>
          <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
            <p>&copy; 2026 KPOL. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
